...
class NavigationManager {
    constructor() {
        this.basePath = window.CONFIG ? CONFIG.BASE_PATH : '';
        this.init();
    }
    ...
    createNavigation() {
        // Create navigation HTML with dynamic paths
        const navHTML = `
            <nav class="top-nav">
                <a href="${this.getPath('/index.html')}" class="nav-brand">
                    <span class="brand-icon">🏢</span>
                    <span class="brand-text">Urban Referral Network</span>
                </a>
                
                <div class="nav-actions">
                    <a href="${this.getPath('/pages/dashboard.html')}" class="nav-btn nav-btn-secondary">
                        <span>📊</span>
                        <span class="btn-text">Dashboard</span>
                    </a>
                    <a href="${this.getPath('/pages/contractor-finder.html')}" class="nav-btn nav-btn-secondary">
                        <span>🔍</span>
                        <span class="btn-text">Find Contractors</span>
                    </a>
                    <a href="${this.getPath('/pages/call-center.html')}" class="nav-btn nav-btn-secondary">
                        <span>📞</span>
                        <span class="btn-text">Call Center</span>
                    </a>
                    <a href="${this.getPath('/pages/training-center.html')}" class="nav-btn nav-btn-primary">
                        <span>🎓</span>
